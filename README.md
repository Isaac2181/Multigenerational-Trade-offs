...
This repository contains the full dataset and analysis scripts associated with the study "Evolutionary Trade-offs Between Intergenerational and Transgenerational Fitness Effects".  
...
| Model tables | `/model_outputs/` | Mixed model outputs exported as `.docx` |
